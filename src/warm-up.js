...
var sequel = `"${title} 2: No Hobbits, No Hope"`;
...
if (pages < 1000) {
    ...
    console.log("Ok, maybe I could read that in a day in a half.");
}
...
if (isFavorite) {
    ...
    console.log(`"I recently read ${title}, a book."`);
}
...
var books = ["Celtic Folktales", "The Hobbit", "Watering The Soul", "Vonnegut: Novels and Stories", "House of Leaves"];
...
var belowTwoHundred = [10, 20, 30, 50, 70, 90, 110, 115, 120, 157, 179, 191];

// Write the code to access the 5th element of the array, using bracket notation.
//path : belowTwoHundred[4]
